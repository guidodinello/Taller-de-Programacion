 ...
 * 
 */
@WebServiceClient(name = "WebServicesService", targetNamespace = "http://webservices/", wsdlLocation = "http://localhost:9127/webservices?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(config.getPublishURL());
