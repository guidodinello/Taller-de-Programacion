<form>
	<a style="text-decoration: none; font-size: larger;"
		href="./consultaPaquete.html">Disfrutar Rocha</a>
	<fieldset disabled>
		<div class="row g-3 align-items-center pt-3">
			...
			<div class="col-auto">
				<input type="" id="inputPassword6" class="form-control disabled"
					aria-describedby="disabled" placeholder="2">
			</div>
	...
	<fieldset disabled>
		<div class="row g-3 align-items-center pt-3">
			...
			<div class="col-auto">
				<input type="" id="inputPassword6" class="form-control disabled"
					aria-describedby="disabled" placeholder="60">
			</div>
	...
	<fieldset disabled>
		<div class="row g-3 align-items-center pt-3">
			...
			<div class="col-auto">
				<input type="" id="inputPassword6" class="form-control disabled"
					aria-describedby="disabled" placeholder="20">
			</div>
	...
	<fieldset disabled>
		<div class="row g-3 align-items-center pt-3">
			...
			<div class="col-auto">
				<input type="" id="inputPassword6" class="form-control disabled"
					aria-describedby="disabled" placeholder="15/08/2022">
			</div>
