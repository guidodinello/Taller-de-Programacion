...
<body>
    ...
    <% SalidaDao salida = (SalidaDao) request.getAttribute("salida"); %>
				...
				<div class="row g-0">
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<div><a href="consultaActividad?nombreActFin=<%= nombreActividad %>">Consulta de Actividad Turistica</a></div>
					...
					<form>
		            	...
		            	<fieldset disabled>
		                	<div class="row g-3 align-items-center pt-3">
		                        ...
		                        <div class="col-auto">
		                        	...
		                        	<%= 
									new SimpleDateFormat("dd/MM/yyyy").format(salida.getFecha().toGregorianCalendar().getTime())
									%>>
		                    	</div>
		                    </div>
						</fieldset>
		                ...
		                <fieldset disabled>
							<div class="row g-3 align-items-center pt-3">
								...
								<div class="col-auto">
									<input type="text" id="inputPassword6" class="form-control disabled" aria-describedby="disabled" placeholder=
									<%= 
									new SimpleDateFormat("HH:mm").format(salida.getFecha().toGregorianCalendar().getTime())
									%>>
								</div>
						...
						<fieldset disabled>
							<div class="row g-3 align-items-center pt-3">
								...
								<div class="col-auto">
									<input type="text" id="inputPassword6" class="form-control disabled" aria-describedby="disabled" placeholder="<%= salida.getTuristasMax() %>">
								</div>
						...
						<fieldset disabled>
							<div class="row g-3 align-items-center pt-3">
								...
								<div class="col-md-8">
									<input type="text" id="disabledTextInput" class="form-control" placeholder="<%= salida.getLugar() %>">
								</div>
							</div>
						</fieldset>
