...
*/
	...
	private boolean checkFormulario() {
		...
		if (nomActividad.isEmpty() || desc.isEmpty() || duraHs.isEmpty() || costo.isEmpty() || nombCiudad.isEmpty() || comboBox.getSelectedIndex() == -1 ||
            ...
            JOptionPane.showMessageDialog(this, "No puede haber campos vacÃ­os", "Alta de Actividad Turistica",
	...
	public void cargarProveedores() {
        ...
        try {
            ...
            // No se imprime mensaje de error sino que simplemente no se muestra ningÃºn elemento
        }
	}
	*/
}
