...
public interface ICtrlActividad {
	...
	public abstract void  altaSalidaTuristica(String nombreSal, Date fechaSal, String lugarSal,int cantMaxTuristas,Date fechaAlta, String actividad)throws YaExisteException;
